...
var JSON_KEY_PRINCIPAL, SELF_AUTHENTICATING_SUFFIX, ANONYMOUS_SUFFIX, MANAGEMENT_CANISTER_PRINCIPAL_TEXT_STR, fromHexString, toHexString, Principal;
var init_esm = __esm({
  "node_modules/@dfinity/principal/lib/esm/index.js"() {
    init_base32();
    init_getCrc();
...
var AgentHTTPResponseError, AgentCallError, AgentQueryError, AgentReadStateError;
var init_errors2 = __esm({
  "node_modules/@dfinity/agent/lib/esm/agent/http/errors.js"() {
    ...
    AgentCallError = class extends AgentError {
    ...
    AgentQueryError = class extends AgentError {
      constructor(message, response, requestId, senderPubkey, senderSig, ingressExpiry) {
        super(message);
        this.response = response;
        this.requestId = requestId;
    ...
    AgentReadStateError = class extends AgentError {
      constructor(message, response, requestId, senderPubkey, senderSig, ingressExpiry) {
        super(message);
        this.response = response;
        this.requestId = requestId;
...
var __classPrivateFieldSet, __classPrivateFieldGet, _Certificate_disableTimeVerification, CertificateVerificationError, NodeType, Certificate, DER_PREFIX, KEY_LENGTH, LookupStatus, LabelLookupStatus;
...
var __classPrivateFieldSet2, __classPrivateFieldGet2, _ExpirableMap_inner, _ExpirableMap_expirationTime, _a, _b, ExpirableMap;
  ...
  "node_modules/@dfinity/agent/lib/esm/utils/expirableMap.js"() {
    ...
    ExpirableMap = class {
      ...
      constructor(options = {}) {
        ...
        __classPrivateFieldSet2(this, _ExpirableMap_inner, new Map([...source].map(([key, value4]) => [key, { value: value4, timestamp: currentTime }])), "f");
        __classPrivateFieldSet2(this, _ExpirableMap_expirationTime, expirationTime, "f");
      }
      /**
      ...
      prune() {
        const currentTime = Date.now();
        for (const [key, entry] of __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").entries()) {
          if (currentTime - entry.timestamp > __classPrivateFieldGet2(this, _ExpirableMap_expirationTime, "f")) {
            __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").delete(key);
          }
        }
        return this;
      }
      ...
      set(key, value4) {
        ...
        __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").set(key, entry);
        return this;
      }
      /**
       ...
       */
      get(key) {
        const entry = __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").get(key);
        if (entry === void 0) {
          return void 0;
        }
        if (Date.now() - entry.timestamp > __classPrivateFieldGet2(this, _ExpirableMap_expirationTime, "f")) {
          __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").delete(key);
          return void 0;
        }
        return entry.value;
       ...
       */
      clear() {
        __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").clear();
      }
      /**
       ...
       */
      entries() {
        const iterator = __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").entries();
       ...
       */
      values() {
        const iterator = __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").values();
        const generator = function* () {
       ...
       */
      keys() {
        return __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").keys();
      }
      /**
      ...
      forEach(callbackfn, thisArg) {
        for (const [key, value4] of __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").entries()) {
       ...
       */
      has(key) {
        return __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").has(key);
      }
      /**
       ...
       */
      delete(key) {
        return __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").delete(key);
      }
      /**
       * get size of the map.
       ...
       */
      get size() {
        return __classPrivateFieldGet2(this, _ExpirableMap_inner, "f").size;
      }
    };
...
var __classPrivateFieldSet3, __classPrivateFieldGet3, _Ed25519PublicKey_rawKey, _Ed25519PublicKey_derKey, Ed25519PublicKey;
  ...
  "node_modules/@dfinity/agent/lib/esm/public_key.js"() {
    ...
    Ed25519PublicKey = class _Ed25519PublicKey {
      ...
      constructor(key) {
        ...
        __classPrivateFieldSet3(this, _Ed25519PublicKey_rawKey, key, "f");
        __classPrivateFieldSet3(this, _Ed25519PublicKey_derKey, _Ed25519PublicKey.derEncode(key), "f");
      }
      static from(key) {
      ...
      get rawKey() {
        return __classPrivateFieldGet3(this, _Ed25519PublicKey_rawKey, "f");
      }
      get derKey() {
        return __classPrivateFieldGet3(this, _Ed25519PublicKey_derKey, "f");
      }
      toDer() {
        return this.derKey;
      }
  ...
  "node_modules/@dfinity/agent/lib/esm/polling/backoff.js"() {
    ...
    ExponentialBackoff = class _ExponentialBackoff {
      constructor(options = _ExponentialBackoff.default) {
        ...
        __classPrivateFieldSet4(this, _ExponentialBackoff_currentInterval, initialInterval, "f");
        __classPrivateFieldSet4(this, _ExponentialBackoff_randomizationFactor, randomizationFactor, "f");
        __classPrivateFieldSet4(this, _ExponentialBackoff_multiplier, multiplier, "f");
        __classPrivateFieldSet4(this, _ExponentialBackoff_maxInterval, maxInterval, "f");
        __classPrivateFieldSet4(this, _ExponentialBackoff_date, date, "f");
        __classPrivateFieldSet4(this, _ExponentialBackoff_startTime, date.now(), "f");
        __classPrivateFieldSet4(this, _ExponentialBackoff_maxElapsedTime, maxElapsedTime, "f");
        __classPrivateFieldSet4(this, _ExponentialBackoff_maxIterations, maxIterations, "f");
      }
      ...
      incrementCurrentInterval() {
        var _a2;
        __classPrivateFieldSet4(this, _ExponentialBackoff_currentInterval, Math.min(__classPrivateFieldGet4(this, _ExponentialBackoff_currentInterval, "f") * __classPrivateFieldGet4(this, _ExponentialBackoff_multiplier, "f"), __classPrivateFieldGet4(this, _ExponentialBackoff_maxInterval, "f")), "f");
        __classPrivateFieldSet4(this, _ExponentialBackoff_count, (_a2 = __classPrivateFieldGet4(this, _ExponentialBackoff_count, "f"), _a2++, _a2), "f");
        return __classPrivateFieldGet4(this, _ExponentialBackoff_currentInterval, "f");
      }
      next() {
...
var init_http = __esm({
  "node_modules/@dfinity/agent/lib/esm/agent/http/index.js"() {
    ...
    init_errors2();
    init_types2();
    __classPrivateFieldSet5 = function(receiver, state, value4, kind, f) {
      if (kind === "m") throw new TypeError("Private method is not writable");
      if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
      if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
      return kind === "a" ? f.call(receiver, value4) : f ? f.value = value4 : state.set(receiver, value4), value4;
    ...
    HttpAgent = class _HttpAgent {
      ...
      constructor(options = {}) {
        ...
        _HttpAgent_verifyQueryResponse.set(this, (queryResponse, subnetStatus) => {
          ...
          const domainSeparator3 = bufFromBufLike(new TextEncoder().encode("\vic-response"));
          for (const sig of signatures) {
            ...
            const separatorWithHash = concat(domainSeparator3, bufFromBufLike(new Uint8Array(hash2)));
        ...
        } else if (__classPrivateFieldGet5(this, _HttpAgent_shouldFetchRootKey, "f")) {
          this.rootKey = null;
        } else {
        ...
        if (options.verifyQuerySignatures !== void 0) {
          __classPrivateFieldSet5(this, _HttpAgent_verifyQuerySignatures, options.verifyQuerySignatures, "f");
        }
        __classPrivateFieldSet5(this, _HttpAgent_retryTimes, (_b2 = options.retryTimes) !== null && _b2 !== void 0 ? _b2 : 3, "f");
        const defaultBackoffFactory = () => new ExponentialBackoff({
          maxIterations: __classPrivateFieldGet5(this, _HttpAgent_retryTimes, "f")
        });
        __classPrivateFieldSet5(this, _HttpAgent_backoffStrategy, options.backoffStrategy || defaultBackoffFactory, "f");
        ...
        if (options.credentials) {
          ...
          __classPrivateFieldSet5(this, _HttpAgent_credentials, `${name}${password ? ":" + password : ""}`, "f");
        }
        __classPrivateFieldSet5(this, _HttpAgent_identity, Promise.resolve(options.identity || new AnonymousIdentity()), "f");
        ...
        __classPrivateFieldSet5(this, _HttpAgent_maxIngressExpiryInMinutes, options.ingressExpiryInMinutes || 5, "f");
      ...
      async getPrincipal() {
        if (!__classPrivateFieldGet5(this, _HttpAgent_identity, "f")) {
          throw new IdentityInvalidError("This identity has expired due this application's security policy. Please refresh your authentication.");
        }
        return (await __classPrivateFieldGet5(this, _HttpAgent_identity, "f")).getPrincipal();
      }
      /**
      ...
      async call(canisterId, options, identity) {
        var _a2, _b2;
        await __classPrivateFieldGet5(this, _HttpAgent_instances, "m", _HttpAgent_rootKeyGuard).call(this);
        const callSync = (_a2 = options.callSync) !== null && _a2 !== void 0 ? _a2 : true;
        const id = await (identity !== void 0 ? await identity : await __classPrivateFieldGet5(this, _HttpAgent_identity, "f"));
        if (!id) {
          throw new IdentityInvalidError("This identity has expired due this application's security policy. Please refresh your authentication.");
        }
        ...
        let ingress_expiry = new Expiry(__classPrivateFieldGet5(this, _HttpAgent_maxIngressExpiryInMinutes, "f") * MINUTE_TO_MSECS);
        if (Math.abs(__classPrivateFieldGet5(this, _HttpAgent_timeDiffMsecs, "f")) > 1e3 * 30) {
          ingress_expiry = new Expiry(__classPrivateFieldGet5(this, _HttpAgent_maxIngressExpiryInMinutes, "f") * MINUTE_TO_MSECS + __classPrivateFieldGet5(this, _HttpAgent_timeDiffMsecs, "f"));
        }
        const submit = {
        ...
        let transformedRequest = await this._transform({
          request: {
            body: null,
            method: "POST",
            headers: Object.assign({ "Content-Type": "application/cbor" }, __classPrivateFieldGet5(this, _HttpAgent_credentials, "f") ? { Authorization: "Basic " + btoa(__classPrivateFieldGet5(this, _HttpAgent_credentials, "f")) } : {})
          },
          endpoint: "call",
          body: submit
        });
        ...
        try {
          const requestSync = () => {
            ...
            return __classPrivateFieldGet5(this, _HttpAgent_fetch, "f").call(this, "" + new URL(`/api/v3/canister/${ecid.toText()}/call`, this.host), Object.assign(Object.assign(Object.assign({}, __classPrivateFieldGet5(this, _HttpAgent_callOptions, "f")), transformedRequest.request), { body }));
          };
          const requestAsync = () => {
            this.log.print(`fetching "/api/v2/canister/${ecid.toText()}/call" with request:`, transformedRequest);
            return __classPrivateFieldGet5(this, _HttpAgent_fetch, "f").call(this, "" + new URL(`/api/v2/canister/${ecid.toText()}/call`, this.host), Object.assign(Object.assign(Object.assign({}, __classPrivateFieldGet5(this, _HttpAgent_callOptions, "f")), transformedRequest.request), { body }));
          };
          ...
          if (responseBody && "certificate" in responseBody) {
            ...
            __classPrivateFieldSet5(this, _HttpAgent_waterMark, time, "f");
          }
          return {
            requestId,
            response: {
      ...
      async query(canisterId, fields, identity) {
        ...
        let queryResult;
        const id = await (identity !== void 0 ? identity : __classPrivateFieldGet5(this, _HttpAgent_identity, "f"));
        if (!id) {
          throw new IdentityInvalidError("This identity has expired due this application's security policy. Please refresh your authentication.");
        }
        const canister = Principal.from(canisterId);
        ...
        const request2 = {
          ...
          arg: fields.arg,
          sender,
          ingress_expiry: new Expiry(__classPrivateFieldGet5(this, _HttpAgent_maxIngressExpiryInMinutes, "f") * MINUTE_TO_MSECS)
        };
        ...
        const makeQuery = async () => {
          return {
            ...
            query: await __classPrivateFieldGet5(this, _HttpAgent_instances, "m", _HttpAgent_requestAndRetryQuery).call(this, args)
          };
        };
        const getSubnetStatus = async () => {
          ...
          const subnetStatus = __classPrivateFieldGet5(this, _HttpAgent_subnetKeys, "f").get(ecid.toString());
          if (subnetStatus) {
            return subnetStatus;
          }
        ...
        try {
          ...
          try {
            return __classPrivateFieldGet5(this, _HttpAgent_verifyQueryResponse, "f").call(this, queryWithDetails, subnetStatus);
          } catch (_e) {
            ...
            return __classPrivateFieldGet5(this, _HttpAgent_verifyQueryResponse, "f").call(this, queryWithDetails, updatedSubnetStatus);
          }
        } catch (error) {
      ...
      async readState(canisterId, fields, identity, request2) {
        ...
        try {
          const response = await __classPrivateFieldGet5(this, _HttpAgent_instances, "m", _HttpAgent_requestAndRetry).call(this, {
            request: () => __classPrivateFieldGet5(this, _HttpAgent_fetch, "f").call(this, "" + new URL(`/api/v2/canister/${canister.toString()}/read_state`, this.host), Object.assign(Object.assign(Object.assign({}, __classPrivateFieldGet5(this, _HttpAgent_fetchOptions, "f")), transformedRequest.request), { body })),
            backoff: backoff2,
            tries: 0
          });
          if (!response.ok) {
...
`);
          ...
          if (parsedTime > 0) {
            ...
            __classPrivateFieldSet5(this, _HttpAgent_waterMark, parsedTime, "f");
          }
      ...
      async syncTime(canisterId) {
        ...
        try {
          ...
          const anonymousAgent = _HttpAgent.createSync({
            ...
            fetch: __classPrivateFieldGet5(this, _HttpAgent_fetch, "f"),
            retryTimes: 0
          });
          ...
          if (replicaTime) {
            __classPrivateFieldSet5(this, _HttpAgent_timeDiffMsecs, Number(replicaTime) - Number(callTime), "f");
            this.log.notify({
              message: `Syncing time: offset of ${__classPrivateFieldGet5(this, _HttpAgent_timeDiffMsecs, "f")}`,
              level: "info"
            });
          }
        } catch (error) {
      ...
      async status() {
        const headers = __classPrivateFieldGet5(this, _HttpAgent_credentials, "f") ? {
          Authorization: "Basic " + btoa(__classPrivateFieldGet5(this, _HttpAgent_credentials, "f"))
        } : {};
        this.log.print(`fetching "/api/v2/status"`);
        const backoff2 = __classPrivateFieldGet5(this, _HttpAgent_backoffStrategy, "f").call(this);
        const response = await __classPrivateFieldGet5(this, _HttpAgent_instances, "m", _HttpAgent_requestAndRetry).call(this, {
          backoff: backoff2,
          request: () => __classPrivateFieldGet5(this, _HttpAgent_fetch, "f").call(this, "" + new URL(`/api/v2/status`, this.host), Object.assign({ headers }, __classPrivateFieldGet5(this, _HttpAgent_fetchOptions, "f"))),
          tries: 0
        });
      ...
      async fetchRootKey() {
        let result;
        if (__classPrivateFieldGet5(this, _HttpAgent_rootKeyPromise, "f")) {
          result = await __classPrivateFieldGet5(this, _HttpAgent_rootKeyPromise, "f");
        } else {
          __classPrivateFieldSet5(this, _HttpAgent_rootKeyPromise, new Promise((resolve, reject) => {
            this.status().then((value4) => {
              const rootKey = value4.root_key;
        ...
        __classPrivateFieldSet5(this, _HttpAgent_rootKeyPromise, null, "f");
        return result;
      }
      invalidateIdentity() {
        __classPrivateFieldSet5(this, _HttpAgent_identity, null, "f");
      }
      replaceIdentity(identity) {
        __classPrivateFieldSet5(this, _HttpAgent_identity, Promise.resolve(identity), "f");
      }
    ...
    _HttpAgent_rootKeyPromise = /* @__PURE__ */ new WeakMap(), _HttpAgent_shouldFetchRootKey = /* @__PURE__ */ new WeakMap(), _HttpAgent_identity = /* @__PURE__ */ new WeakMap(), _HttpAgent_fetch = /* @__PURE__ */ new WeakMap(), _HttpAgent_fetchOptions = /* @__PURE__ */ new WeakMap(), _HttpAgent_callOptions = /* @__PURE__ */ new WeakMap(), _HttpAgent_timeDiffMsecs = /* @__PURE__ */ new WeakMap(), _HttpAgent_credentials = /* @__PURE__ */ new WeakMap(), _HttpAgent_retryTimes = /* @__PURE__ */ new WeakMap(), _HttpAgent_backoffStrategy = /* @__PURE__ */ new WeakMap(), _HttpAgent_maxIngressExpiryInMinutes = /* @__PURE__ */ new WeakMap(), _HttpAgent_waterMark = /* @__PURE__ */ new WeakMap(), _HttpAgent_queryPipeline = /* @__PURE__ */ new WeakMap(), _HttpAgent_updatePipeline = /* @__PURE__ */ new WeakMap(), _HttpAgent_subnetKeys = /* @__PURE__ */ new WeakMap(), _HttpAgent_verifyQuerySignatures = /* @__PURE__ */ new WeakMap(), _HttpAgent_verifyQueryResponse = /* @__PURE__ */ new WeakMap(), _HttpAgent_instances = /* @__PURE__ */ new WeakSet(), _HttpAgent_requestAndRetryQuery = async function _HttpAgent_requestAndRetryQuery2(args) {
      ...
      try {
        ...
        const fetchResponse = await __classPrivateFieldGet5(this, _HttpAgent_fetch, "f").call(this, "" + new URL(`/api/v2/canister/${ecid.toString()}/query`, this.host), Object.assign(Object.assign(Object.assign({}, __classPrivateFieldGet5(this, _HttpAgent_fetchOptions, "f")), transformedRequest.request), { body }));
...
`;
      ...
      if (this.rootKey) {
        return;
      } else if (this.rootKey === null && __classPrivateFieldGet5(this, _HttpAgent_shouldFetchRootKey, "f")) {
        await this.fetchRootKey();
      } else {
        throw new AgentError(`Invalid root key detected. The root key for this agent is ${this.rootKey} and the shouldFetchRootKey value is set to ${__classPrivateFieldGet5(this, _HttpAgent_shouldFetchRootKey, "f")}. The root key should only be unknown if you are in local development. Otherwise you should avoid fetching and use the default IC Root Key or the known root key of your environment.`);
      }
    };
  }
});
...
var Actor = class _Actor {
   ...
   */
  static agentOf(actor2) {
    return actor2[metadataSymbol].config.agent;
  }
  /**
   * Get the interface of an actor, in the form of an instance of a Service.
   * @param actor The actor to get the interface of.
   */
  static interfaceOf(actor2) {
    return actor2[metadataSymbol].service;
  }
  static canisterIdOf(actor2) {
    return Principal.from(actor2[metadataSymbol].config.canisterId);
  }
...
function _createActorMethod(actor2, methodName, func, blsVerify2) {
  let caller;
  if (func.annotations.includes("query") || func.annotations.includes("composite_query")) {
    caller = async (options, ...args) => {
      var _a2, _b2;
      options = Object.assign(Object.assign({}, options), (_b2 = (_a2 = actor2[metadataSymbol].config).queryTransform) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, methodName, args, Object.assign(Object.assign({}, actor2[metadataSymbol].config), options)));
      const agent = options.agent || actor2[metadataSymbol].config.agent || getDefaultAgent();
      const cid = Principal.from(options.canisterId || actor2[metadataSymbol].config.canisterId);
    ...
    caller = async (options, ...args) => {
      var _a2, _b2;
      options = Object.assign(Object.assign({}, options), (_b2 = (_a2 = actor2[metadataSymbol].config).callTransform) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, methodName, args, Object.assign(Object.assign({}, actor2[metadataSymbol].config), options)));
      const agent = options.agent || actor2[metadataSymbol].config.agent || getDefaultAgent();
      const { canisterId, effectiveCanisterId, pollingStrategyFactory } = Object.assign(Object.assign(Object.assign({}, DEFAULT_ACTOR_CONFIG), actor2[metadataSymbol].config), options);
...
var Ed25519PublicKey2 = class _Ed25519PublicKey {
  ...
  constructor(key) {
    ...
    __classPrivateFieldSet6(this, _Ed25519PublicKey_rawKey2, bufFromBufLike(key), "f");
    __classPrivateFieldSet6(this, _Ed25519PublicKey_derKey2, _Ed25519PublicKey.derEncode(key), "f");
  }
  /**
  ...
  get rawKey() {
    return __classPrivateFieldGet6(this, _Ed25519PublicKey_rawKey2, "f");
  }
  get derKey() {
    return __classPrivateFieldGet6(this, _Ed25519PublicKey_derKey2, "f");
  }
  toDer() {
    return this.derKey;
  }
...
var Ed25519KeyIdentity = class _Ed25519KeyIdentity extends SignIdentity {
  ...
  constructor(publicKey, privateKey) {
    ...
    __classPrivateFieldSet6(this, _Ed25519KeyIdentity_publicKey, Ed25519PublicKey2.from(publicKey), "f");
    __classPrivateFieldSet6(this, _Ed25519KeyIdentity_privateKey, new Uint8Array(privateKey), "f");
  }
  /**
   ...
   */
  toJSON() {
    return [toHex(__classPrivateFieldGet6(this, _Ed25519KeyIdentity_publicKey, "f").toDer()), toHex(__classPrivateFieldGet6(this, _Ed25519KeyIdentity_privateKey, "f"))];
  }
  /**
  ...
  getKeyPair() {
    return {
      secretKey: __classPrivateFieldGet6(this, _Ed25519KeyIdentity_privateKey, "f"),
      publicKey: __classPrivateFieldGet6(this, _Ed25519KeyIdentity_publicKey, "f")
    };
  }
  /**
   ...
   */
  getPublicKey() {
    return __classPrivateFieldGet6(this, _Ed25519KeyIdentity_publicKey, "f");
  }
  /**
  ...
  async sign(challenge) {
    ...
    const signature = uint8ToBuf(ed25519.sign(blob, __classPrivateFieldGet6(this, _Ed25519KeyIdentity_privateKey, "f").slice(0, 32)));
...
var PartialIdentity = class {
  constructor(inner) {
    ...
    __classPrivateFieldSet7(this, _PartialIdentity_inner, inner, "f");
  }
  /**
   * The raw public key of this identity.
   */
  get rawKey() {
    return __classPrivateFieldGet7(this, _PartialIdentity_inner, "f").rawKey;
  }
  /**
   * The DER-encoded public key of this identity.
   */
  get derKey() {
    return __classPrivateFieldGet7(this, _PartialIdentity_inner, "f").derKey;
  }
  /**
   * The DER-encoded public key of this identity.
   */
  toDer() {
    return __classPrivateFieldGet7(this, _PartialIdentity_inner, "f").toDer();
  }
  /**
   * The inner {@link PublicKey} used by this identity.
   */
  getPublicKey() {
    return __classPrivateFieldGet7(this, _PartialIdentity_inner, "f");
  }
  /**
   * The {@link Principal} of this identity.
   */
  getPrincipal() {
    if (!__classPrivateFieldGet7(this, _PartialIdentity_inner, "f").rawKey) {
      throw new Error("Cannot get principal from a public key without a raw key.");
    }
    return Principal.fromUint8Array(new Uint8Array(__classPrivateFieldGet7(this, _PartialIdentity_inner, "f").rawKey));
  }
  /**
...
var Delegation = class {
  ...
  toCBOR() {
    return cbor3.value.map(Object.assign({ pubkey: cbor3.value.bytes(this.pubkey), expiration: cbor3.value.u64(this.expiration.toString(16), 16) }, this.targets && {
      targets: cbor3.value.array(this.targets.map((t) => cbor3.value.bytes(bufFromBufLike2(t.toUint8Array()))))
    }));
  }
  toJSON() {
...
var PartialDelegationIdentity = class _PartialDelegationIdentity extends PartialIdentity {
  constructor(inner, delegation) {
    ...
    __classPrivateFieldSet8(this, _PartialDelegationIdentity_delegation, delegation, "f");
  }
  /**
   * The Delegation Chain of this identity.
   */
  get delegation() {
    return __classPrivateFieldGet8(this, _PartialDelegationIdentity_delegation, "f");
  }
  /**
...
var __classPrivateFieldSet9 = function(receiver, state, value4, kind, f) {
  if (kind === "m") throw new TypeError("Private method is not writable");
  if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
  if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
  return kind === "a" ? f.call(receiver, value4) : f ? f.value = value4 : state.set(receiver, value4), value4;
...
var IdbStorage = class {
  ...
  constructor(options) {
    ...
    __classPrivateFieldSet9(this, _IdbStorage_options, options !== null && options !== void 0 ? options : {}, "f");
  }
  get _db() {
    return new Promise((resolve) => {
      ...
      IdbKeyVal.create(__classPrivateFieldGet9(this, _IdbStorage_options, "f")).then((db) => {
...
// src/app.js
init_esm2();
var CANISTER_ID = "od2mb-wyaaa-aaaac-qgmza-cai";
var IC_HOST = "https://icp0.io";
var II_URL = "https://identity.ic0.app";
var CHUNK_SIZE = 4e5;
var idlFactory = ({ IDL }) => IDL.Service({
...
async function call(method, arg) {
  const raw = arg !== void 0 ? await actor[method](JSON.stringify(arg)) : await actor[method]();
...
function showErr(msg) {
  ...
  setTimeout(() => b.classList.add("hidden"), 6e3);
}
      ...
      container.innerHTML = nsList.map((ns) => `
        <div onclick="showNsDetail('${esc(ns.namespace)}')"
          class="flex items-center justify-between p-4 bg-gray-900 border border-gray-800 rounded-xl
                 hover:border-blue-700 hover:bg-gray-800 transition-all cursor-pointer group">
          <div class="flex items-center gap-3">
            ...
            <span class="font-mono text-sm text-white group-hover:text-blue-300 transition-colors">
              ${esc(ns.namespace)}
            </span>
          </div>
...
window.loadDetail = async (ns) => {
  try {
    ...
    el("detailFileCount").textContent = `${files.length} ${files.length === 1 ? "file" : "files"}`;
    if (!files.length) {
      el("fileTable").innerHTML = '<div class="text-center py-12 text-gray-500"><p>No files in this namespace yet.</p></div>';
      return;
    }
          ...
          <tbody>
            ${files.map((f) => `
              <tr class="border-b border-gray-800/50 hover:bg-gray-800/40 transition-colors">
                <td class="px-4 py-3 font-mono text-xs text-blue-300">${esc(f.path)}</td>
                <td class="px-4 py-3 text-gray-400 text-xs hidden sm:table-cell">${esc(f.content_type)}</td>
                ...
                <td class="px-4 py-3">
                  <div class="flex items-center justify-end gap-2">
                    ...
                    <button onclick="handleDeleteFile('${esc(ns)}','${esc(f.path)}')"
                      title="Delete"
                      class="p-1.5 rounded-lg hover:bg-red-900/40 text-gray-500 hover:text-red-400 transition-colors text-xs">
                      \u{1F5D1}
                    </button>` : ""}
                  </div>
                </td>
